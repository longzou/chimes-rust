...
#[crud_table(table_name:"chimes_scope"|table_columns:"id,name,code,create_by,update_by,create_time,update_time")]
#[derive(Debug, Clone, Default, Deserialize, Serialize)]
pub struct ChimesDataScope {
    #[serde(default)]
